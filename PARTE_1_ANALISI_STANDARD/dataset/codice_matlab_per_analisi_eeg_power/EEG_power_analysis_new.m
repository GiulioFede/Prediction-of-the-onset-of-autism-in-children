...
path_summary_eeg_power_per_channel = 'D:\Personal\Tesi_Magistrale\PARTE_1_ANALISI_STANDARD\dataset\LO0195\non_sociale_asincrono\eeg_power_analysis_results\summary_egg_power_per_channel.txt';
%inserire il path dove verrà salvata la stessa informazione ma in csv senza
%altro testo di contorno
path_summary_eeg_power_per_channel_csv = 'D:\Personal\Tesi_Magistrale\PARTE_1_ANALISI_STANDARD\dataset\LO0195\non_sociale_asincrono\eeg_power_analysis_results\egg_power_per_channel.csv';

%inserire il path dove verrà salvato il file summary_egg_power_per_region.txt
path_summary_eeg_power_per_region = 'D:\Personal\Tesi_Magistrale\PARTE_1_ANALISI_STANDARD\dataset\LO0195\non_sociale_asincrono\eeg_power_analysis_results\summary_egg_power_per_region.txt';
%inserire il path dove verrà salvata la stessa informazione ma in csv senza
%altro testo di contorno
path_summary_eeg_power_per_region_csv = 'D:\Personal\Tesi_Magistrale\PARTE_1_ANALISI_STANDARD\dataset\LO0195\non_sociale_asincrono\eeg_power_analysis_results\egg_power_per_region.csv';
